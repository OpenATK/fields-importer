 ...
 */
'use strict'; // TODO: URIjs is:ta big, find smaller alternative
...
function popUpRedirect(authFun, opts) {
  return function (domain, options, callback) {
    ...
    var win = window.open('', '_blank', 'width=500,height=400,status,resizable,scrollbars=yes'); // TODO: Do this differently
